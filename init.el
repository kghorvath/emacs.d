...
(custom-set-variables
 ...
 '(package-selected-packages
   '(corfu elpy yaml-mode json-mode markdown-mode ef-themes auctex pdf-tools evil magit no-littering ement mastodon sudo-edit spacemacs-theme solarized-theme))
